...
public class MovieText2 : MonoBehaviour
{
    ...
    IEnumerator Display()
    {
        sr = new StreamReader(Application.streamingAssetsPath + "/text3.txt");
        //创建一个流，用于读取行数
        StreamReader srLine = new StreamReader(Application.streamingAssetsPath + "/text3.txt");
        //循环来读取行数，直到为null停止
